...
{
	final switch (reloc) with (RelocType) {
	case FuncIndexLEB: return "FuncIndexLEB";
	case TableIndexSLEB: return "TableIndexSLEB";
	case TableIndexI32: return "TableIndexI32";
	case MemoryAddressLEB: return "MemoryAddressLEB";
	case MemoryAddressSLEB: return "MemoryAddressSLEB";
	case MemoryAddressI32: return "MemoryAddressI32";
	case TypeIndexLEB: return "TypeIndexLEB";
	case GlobalIndexLEB: return "GlobalIndexLEB";
	}
}
